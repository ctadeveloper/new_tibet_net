        ...
        <div class="row py-3">
            ...
            while ($human_right->have_posts()) : $human_right->the_post();
                ...
                if ($post_index_img != '') {
                    ...
                    $img_html = '<img class="rounded img-responsive w-100 rounded-top lazyload blur-up" data-src="' . get_template_directory_uri() . '/img/cta_grid_default-280x140.jpg" height="140" width="280" alt="' . get_the_title() . '"' . "\r\n";
